    ...
    <div class="container-fluid" wire:ignore.self>
        ...
        <div class="row ml-2">
            <div class="form-group  col-10">
                <x-label-section>{{ trans('general.observations') }}</x-label-section>
                <textarea wire:model.defer="observation" rows="1" id="observations" class="form-control bg-transparent @error($observation) is-invalid @enderror"></textarea>
                                    ...
                                    @foreach($file_s as $index => $file)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button class="border-0 bg-transparent" wire:click="$emit('fileDelete', '{{ $file['id']}}')" data-toggle="tooltip"
