<div wire:ignore.self class="modal fade" id="edit_catalog_activity_modal" tabindex="-1" role="dialog" aria-hidden="true"
     style="height: 100%;">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <div wire:ignore class="modal-header bg-primary text-white">
                <h5 class="modal-title">{{ trans('general.poa_activity_catalog_adit_title_modal') }}</h5>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <div class="input-group">
                            ...
                            <div class="invalid-feedback">{{ $errors->first('impact') }}</div>
                        </div>
                        <label class="form-label required"
