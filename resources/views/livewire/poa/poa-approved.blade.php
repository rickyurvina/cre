<div wire:ignore.self class="modal fade in" id="poa-approve-poa" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                ...
                <div class="modal-body">
                    <div class="card-body pt-0">
                        <div class="w-75 mx-auto">
                            ...
                            @error('files')
                            <div class="alert alert-danger fade show ml-6" role="alert">
