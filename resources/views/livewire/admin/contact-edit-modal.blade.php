<div wire:ignore.self class="modal fade" id="edit_contact_modal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="panel-content">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#generalEdit" role="tab" aria-selected="true" wire:ignore.self>
                                <i class="fal fa-user text-primary"></i>
                                <span class="hidden-sm-down ml-1">Información General</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#aditionalEdit" role="tab" aria-selected="false" wire:ignore.self>
                                <i class="fal fa-address-card"></i>
                                <span class="hidden-sm-down ml-1">Datos Adicionales</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#filesEdit" role="tab" aria-selected="false" wire:ignore.self>
                                <i class="fal fa-address-card"></i>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <span class="input-group-text bg-transparent border-right-0">
                                                ...
                                                <div
                                                        class="invalid-feedback">{{ $errors->first('businessPhone') }}</div>
                                            </div>
                                        </div>

                                        <div class="form-group col-6">
                                            <label class="form-label"
                                                   for="gender">{{ trans('general.department') }}</label>
                                            <div class="input-group bg-white shadow-inset-2">
                                                <div class="input-group-prepend">
                                                        <span class="input-group-text bg-transparent border-right-0">
                            ...
                            <div class="w-75 mx-auto">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea wire:model.defer="observationEdit" rows="1" id="filecoments" class="form-control bg-transparent"></textarea>
                                    ...
                                    @foreach($filesEdit as $item)
                                        @if(!$item['delete'])
                                            <tr>
                                                ...
                                                <td><span wire:click="removeEditFile('{{ $item['name'] }}')" class="cursor-pointer trash"><i class="fas fa-trash
