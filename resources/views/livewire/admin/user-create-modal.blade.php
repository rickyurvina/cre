<div wire:ignore.self class="modal fade" id="add_user_modal" tabindex="-1" role="dialog" aria-hidden="true"
     style="height: 100%;">
            ...
            <div class="modal-body">
                ...
                <div class="panel-content">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#departamentos" role="tab"
                               aria-selected="false">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#aditional" role="tab" aria-selected="false">
                                <i class="fal fa-address-card"></i>
                                <span class="hidden-sm-down ml-1">Datos Adicionales</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#files" role="tab" aria-selected="false">
                                <i class="fal fa-address-card"></i>
                    ...
                    <div class="tab-content border border-top-0 p-3">
                        <div class="card tab-pane fade show active" id="general" role="tabpanel" wire:ignore>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div class="input-group bg-white shadow-inset-2">
                                            ...
                                            <select wire:model.defer="gender"
                                                ...
                                                <option value="" selected>{{ trans('general.form.select.field', ['field' => trans('general.gender')]) }}</option>
                        ...
                        <div class="card tab-pane fade show" id="departamentos" role="tabpanel" wire:ignore.self>
                            <div class="card-body pt-0">
                                <div class="w-100 mx-auto">
                                    <div class="row">
                                        <div class="form-group col-6">
                                            <label class="form-label"
                                                   for="gender">{{ trans('general.companies') }}</label>
                                            <div class="input-group bg-white shadow-inset-2">
                                                <div class="input-group-prepend">
                                                                        <span class="input-group-text bg-transparent border-right-0">
                                                ...
                                                <select wire:model.defer="idCompany" wire:change="companySelection"
                                                    ...
                                                    <option value=""
                                                            selected>{{ trans('general.form.select.field', ['field' => trans('general.companies')]) }}</option>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            @if( isset($idCompany))
                                                @foreach($userDepartmentsIds as $department)
                                                    <div>
                                                        <input
                                                                wire:model="userDepartmentsIds.{{ $loop->index }}.selected"
                        ...
                        <div class="card tab-pane fade" id="aditional" role="tabpanel" wire:ignore>
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-6">
                                        <label class="form-label"
                        ...
                        <div class="card tab-pane fade" id="files" role="tabpanel" wire:ignore>
                            <div class="card-body pt-0">
                                <div class="w-75 mx-auto">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <textarea wire:model.defer="observation" rows="1" id="filecoments"
                                    ...
                                    <table class="table m-0">
                                        ...
                                        @foreach($files as $item)
                                            <tr>
                                                ...
                                                <td><span wire:click="removeFile('{{ $item['name'] }}')"
                                                          class="cursor-pointer trash"><i class="fas fa-trash
                                                text-danger"></i></span></td>
                                            </tr>
                                        @endforeach
