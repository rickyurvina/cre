                    ...
                    <div class="table-responsive">
                        <table class="table table-light table-hover">
                            ...
                            <tr>
                                ...
                                <th class="w-auto table-th">{{__('budget.item_code')}}</th>
                            ...
                            @foreach($accounts->take($countRegisterSelect) as $item)
                                <tr>
                                    ...
                                    <td class="table-th">{{$item->name}}</td>
                                    <td class="table-th">{{$item->balance}}</td>
                                    <td>
            ...
            @if($account)
                ...
                <div class="d-flex flex-wrap w-100">
                    ...
                    <div class="d-flex flex-column p-2 w-50">
                        ...
                        @if($transaction->reform_type==\App\Models\Budget\Transaction::REFORM_TYPE_INCREMENT || $transaction->reform_type==\App\Models\Budget\Transaction::REFORM_TYPE_TRANSFER)
                            <div class="detail">
                    ...
                    <div class="d-flex flex-column p-2 w-50">
                        ...
                        @if($transaction->reform_type==\App\Models\Budget\Transaction::REFORM_TYPE_DECREASE || $transaction->reform_type==\App\Models\Budget\Transaction::REFORM_TYPE_TRANSFER )
                            <div class="detail">
                                <div class="form-group col-md-12 required">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                    ...
                    <div class="table-responsive">
                        <table class="table table-light">
                            ...
                            <tr>
                                ...
                                <th class="w-10 table-th">{{__('general.name')}}</th>
                            ...
                            @foreach($arrayReformsIncomes as $index => $itemIncome)
                                <tr class="">
                                    ...
                                    <th class="w-50 table-th">{{$itemIncome['name']}}</th>
                                    @isset($itemIncome['id'])
                                        <th class="table-th">{{ money( $itemIncome['credit']) }}</th>
                                        <th class=" table-th">{{ money( $itemIncome['debit']) }}</th>
                                    @else
                                        <th class="table-th">${{ $itemIncome['credit'] }}</th>
                                        <th class=" table-th">${{ $itemIncome['debit'] }}</th>
                                    @endisset
                            ...
                            @endforeach
                            @if($transaction->reform_type==\App\Models\Budget\Transaction::REFORM_TYPE_TRANSFER)
                                <tr style="background-color: #e0e0e0">
                                    ...
                                    <td class="fs-2x fw-700 @if($subTotalIncomeDecrease==$subTotalIncomeIncrement)  color-success-700 @else color-danger-700 @endif">
                                        {{ money( $subTotalIncomeIncrement)}}
                                    </td>
                                    <td class="fs-2x fw-700 @if($subTotalIncomeDecrease==$subTotalIncomeIncrement) color-success-700 @else color-danger-700 @endif">
                                        {{ money( $subTotalIncomeDecrease)}}
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            ...
                            @foreach($arrayReformsExpenses as $index => $itemExpense)
                                <tr class="">
                                    <th class=" table-th">{{$itemExpense['code']}}</th>
                                    <th class=" table-th">{{ $itemExpense['name']}}</th>
                                    @isset( $itemExpense['id'])
                                        <th class="table-th">{{ money( $itemExpense['credit']) }}</th>
                                        <th class=" table-th">{{ money( $itemExpense['debit']) }}</th>
                                    @else
                                        <th class="table-th">${{$itemExpense['credit']}}</th>
                                        <th class=" table-th">${{$itemExpense['debit']}}</th>
                                    @endisset
                                    <th class="w-20 table-th">
                            ...
                            @if($transaction->reform_type==\App\Models\Budget\Transaction::REFORM_TYPE_TRANSFER)
                                <tr style="background-color: #e0e0e0">
                                    ...
                                    <td class="fs-2x fw-700 @if($subTotalExpenseIncrement==$subTotalExpenseDecrease) color-success-700 @else color-danger-700 @endif">
                                        {{money( $subTotalExpenseIncrement)}}
                                    </td>
                                    <td class="fs-2x fw-700 @if($subTotalExpenseIncrement==$subTotalExpenseDecrease) color-success-700 @else color-danger-700 @endif">
                                        {{money( $subTotalExpenseDecrease)}}
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            ...
                            <tr style="background-color: #e0e0e0">
                                ...
                                <td class="fs-2x fw-700 @if($totalDecreases==$totalIncrements) color-success-700 @else color-danger-700 @endif">
                                    {{money( $totalIncrements)}}
                                </td>
                                <td class="fs-2x fw-700 @if($totalDecreases==$totalIncrements) color-success-700 @else color-danger-700 @endif">
                                    {{money( $totalDecreases)}}
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
