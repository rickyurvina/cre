              ...
              <div class="row">
                <div class="form-group col-lg-4 ">
                  <label class="form-label"
                         for="code">{{ trans('general.code') }} {{ trans_choice('general.indicators', 1) }}</label>
                  <label class="form-label" for="code">{{ $code }}</label>
                </div>
                <div class="form-group col-lg-4 ">
                  <label class="form-label"
                         for="name">{{ trans('general.name') }} {{ trans_choice('general.indicators', 1) }}</label>
                ...
                <div class="form-group col-lg-4 ">
                  <label class="form-label"
                         for="indicator_units_id">{{ trans('indicators.indicator.unit_of_measurement') }}</label>
              ...
              @if(isset($labelPeriod))
                <div class="input-group bg-white shadow-inset-2">
                  <div class="col-2 mb-1">
                    <x-form.inputs.text type="text" label="{{$labelPeriod}}" name="actual_value" id="actual_value"
                                        class="mb-0"
            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group col-lg-12 ">
                  <label class="form-label"
                         for="code">{{trans('indicators.indicator.there_are_registered_goals')}}</label>
                </div>
              </div>
            </div>
          </div>
