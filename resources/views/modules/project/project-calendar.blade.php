        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                dateClick: function (info) {
                        ...
                        window.livewire.emitTo('projects.logic-frame.project-create-result-activity', 'openCreateModal', {date: date});
                    }
                    @endif
                },
                eventClick: function (calEvent, jsEvent, view) {
                    let id = calEvent.event.id;
                    window.livewire.emitTo('projects.activities.project-register-advance-activity', 'openAdvance', {
                        id: id,
                        isCalendar: true
                    });
                },
