...
@section('project-page')
    ...
    <div id="panel-6">
        <div class="d-flex flex-row-reverse">
            <livewire:risks.create-risk :modelId="$project->id" :class="$class" :messages="$messages"/>
        </div>
            ...
            <div class="panel-content">
                ...
                <div class="tab-content p-3">
                        ...
                        <div class="col-12">
                            @if($risks->count()>0)
                                ...
                                <div class="table-responsive">
                                    ...
                                    <livewire:risks.updated-risk :modelId="$project->id" :class="$class"/>
                                </div>
                    ...
                    <div class="tab-pane fade" id="tab-profile" role="tabpanel" aria-labelledby="tab-profile">
                        <div class="row">
                            <div class="col-12">
                                <div id="chartHeadMapRisks" style="width: 100% !important; height: 600px !important; font-size: xx-small !important;"></div>
                            </div>
                        </div>
                    </div>
                </div>
