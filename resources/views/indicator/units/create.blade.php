...
@section('title', trans('general.title.create', ['type' => trans_choice('general.units', 1)]))

@section('subheader-title')
    <i class="fal fa-plus text-primary"></i> {{ trans('general.title.create', ['type' => trans_choice('general.units', 1)]) }}
@endsection

@section('content')
    <div class="card">
        <form action="{{ route('indicator_units.store') }}" method="post">
            @csrf
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <div class="input-group bg-white shadow-inset-2">
                            ...
                            <input type="text" name="abbreviation" id="abbreviation"
                                   class="form-control border-left-0 bg-transparent pl-0 @error('abbreviation') is-invalid @enderror"
                                   value="{{ old('abbreviation') }}" placeholder="{{ trans('general.form.enter', ['field' => trans('general.Abbreviation')]) }}">
