...
@section('title', trans('general.title.create', ['type' => trans_choice('general.thresholds', 1)]))

@section('subheader-title')
    <i class="fal fa-plus text-primary"></i> {{ trans('general.title.create', ['type' => trans_choice('general.thresholds', 1)]) }}
@endsection
                        ...
                        <div class="col-sm-12 col-lg-12">
                            <table id="dt-basic-example" class="table table-bordered table-striped w-100 dataTable no-footer dtr-inline" role="grid"
                                ...
                                <tr id="1" role="row" class="add">
                                    ...
                                    <td class="dtr-control">
                                        <input type="number" readonly name="maxAD" id="maxAD" class="border-0">
                                    </td>
                                </tr>
                                <tr id="1" role="row" class="add">
                                    <td class="dtr-control">
                                ...
                                <tr id="1" role="row" class="add">
                                    ...
                                    <td class="dtr-control">
                                        <input type="number" id="minAS" name="minAS" readonly class="border-0">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="col-sm-12">
                            <table id="dt-basic-example" class="table table-bordered table-striped w-100 dataTable no-footer dtr-inline" role="grid"
                                ...
                                <tr id="1" role="row" class="add">
                                    ...
                                    <td class="dtr-control">
                                        <input type="number" readonly name="maxDD" id="maxDD" class="border-0">
                                    </td>
                                </tr>
                                <tr id="1" role="row" class="add">
                                    <td class="dtr-control">
                                ...
                                <tr id="1" role="row" class="add">
                                    ...
                                    <td class="dtr-control">
                                        <input type="number" readonly name="minDS" id="minDS" class="border-0">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="col-sm-12">
                            <table id="dt-basic-example" class="table table-bordered table-striped w-100 dataTable no-footer dtr-inline" role="grid"
                                ...
                                <tr id="1" role="row" class="add">
                                    ...
                                    <td class="dtr-control">
                                        <input type="number" readonly name="maxTD" id="maxTD" class="border-0">
                                    </td>
                                </tr>
                                <tr id="1" role="row" class="add">
                                    <td class="dtr-control">
                                ...
                                <tr id="1" role="row" class="add">
                                    ...
                                    <td class="dtr-control">
                                        <input type="number" readonly name="minTS" id="minTS" class="border-0">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
