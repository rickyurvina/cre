...
namespace App\Http\Livewire\ProjectsInternal\Formulation\ReferentialBudget;
...
class ProjectReferentialBudget extends Component
{
    ...
    {
        return view('livewire.projectsInternal.formulation.referential_budget.project-referential-budget');
    }
}
