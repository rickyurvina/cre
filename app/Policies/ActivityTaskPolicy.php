...
class ActivityTaskPolicy
{
     ...
     *
     * @param  \App\Models\Auth\User  $user
     * @param  \App\Models\ActivityTask  $activityTask
     * @return \Illuminate\Auth\Access\Response|bool
     */
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, ActivityTask $activityTask)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, ActivityTask $activityTask)
    {
        //
    }
}
